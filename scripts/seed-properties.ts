...
export const seedProperties = [
    ...
    },
    {
        ...
        property_type: "Villa",
        status: "New",
        description: "World-class private waterfront residence with deep-water dock, glass elevator, infinity pool, outdoor outdoor kitchen, and breathtaking Seattle skyline backdrop.",
    ...
    },
    {
        ...
        status: "For sale",
        description: "Classic grand victorian townhouse thoroughly modernized with custom European kitchen, wine lounge, roof deck overlooking San Francisco Bay and Golden Gate Gate.",
...
async function main() {
    console.log(`Inserting/Upserting ${seedProperties.length} properties...`);
