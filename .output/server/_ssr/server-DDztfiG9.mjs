import "../_runtime.mjs";
import { G as defineHandlerCallback, J as RouterProvider, W as renderRouterToStream, at as require_react, ot as globalthis_default, rt as require_jsx_runtime } from "../_chunks/vendor.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-g70N9zg_.mjs");
...
var manifest = {
	"09b72bc94e2be51793d6f47942cba4909edfb598a4bb897026c48a6ddd160a52": {
		functionName: "deleteInquiry_createServerFn_handler",
		importer: () => import("./properties.functions-Cli1ZJhK.mjs")
	},
	"0bbdabb14a6d07168f2fbd648a5246ffdd5da05bdb05ee04662d9cc565f9926e": {
		functionName: "listInquiries_createServerFn_handler",
		importer: () => import("./properties.functions-Cli1ZJhK.mjs")
	},
	"53f41f5cf200ffc06226bf8ce64e9c6088bd68976e6a7ca768cffa76e88ad21e": {
	...
	"821a70f3826f6ea0dd942d6d8f89b9cc5743cf6946316bcbcd8bfc68b637d8c7": {
	...
	"c249c6ef51360b10b73dada911a835ce4ef664d107a3f8cb7e960c2188e39b79": {
	...
	"ed6df5044164a9803ede2dfb54f17246335822b32afc99e183988e70f39e2f4c": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CT30szsA.mjs").then((n) => n.t),
		import("./start-h1kk2254.mjs"),
		import("./empty-plugin-adapters-Ug-b4TCe.mjs")
	]);
	return {
		routerEntry,
		startEntry,
...
//#endregion
export { TSS_SERVER_FUNCTION as a, createServerFn as i, createCsrfMiddleware as n, getServerFnById as o, createMiddleware as r, __exportAll as s, server_exports as t };
